...
<h1 align="center"> OMEGA (*O*bserving *M*apping *E*fficiency over *G*NN *A*ccelerator) </h1>

OMEGA framework is the cost model for inter-phase Graph Neural Network (GNN) dataflows. OMEGA can be used to model other SpMM and GEMM multiphase dataflows as well.

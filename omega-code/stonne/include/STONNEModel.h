...
public:
   ...
   void loadGEMMTile(unsigned int T_N, unsigned int T_K, unsigned int T_M);
    ...
    unsigned int getCycles(){return this->n_cycles;}
    void loadClocking(unsigned int* clocked_op);
    //Getting stats from code
    SDMemoryStats getMemoryStats();
    MSNetworkStats getMultiplierNetworkStats();
    ASNetworkStats getASNetworkStats();
    DSNetworkStats getDSNetworkStats();

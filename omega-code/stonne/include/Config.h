...
public:
    ...
    MemoryHierarchy_t mem_hierarchy_type; //Type of the memory hierarchy (e.g., DOUBLE_BUFFER or BUFFET)
    unsigned int l1_sram_weight_size; //Weight sram size in KB
    unsigned int l1_sram_input_size;  //Input sram size in KB
    unsigned int l1_sram_output_size; //output sram size in KB
    unsigned int l1_sram_weight_latency; //weight sram latency (i.e., number of cycles)
    unsigned int l1_sram_input_latency; //input sram latency (i.e., number of cycles)
    unsigned int l1_sram_output_latency; //output sram latency (i.e., number of cycles)
    void printConfiguration(std::ofstream& out, unsigned int indent);
